...
<div align="center">
    ...
    <a href="https://crates.io/crates/tauri_wasm"><img src="https://img.shields.io/crates/v/tauri_wasm?style=flat-square"></a>
</div>

<div align="center">
    <img src="https://img.shields.io/badge/API_Version-2.9.5-FE7A36">
    <img src="https://img.shields.io/badge/tauri__wasm-unofficial-FE7A36">
...
```toml
[dependencies]
tauri_wasm = { git = "https://github.com/p1mo/tauri-wasm", tag = "v0.1.3-dev", features = [
