...
const REPLACEMENTS  = [
    [ "@tauri-apps/api/app", "tauri-v2/packages/api/src/app.ts" ],
    [ "@tauri-apps/api/core", "tauri-v2/packages/api/src/core.ts" ],
    [ "@tauri-apps/api/dpi", "tauri-v2/packages/api/src/dpi.ts" ],
    [ "@tauri-apps/api/event", "tauri-v2/packages/api/src/event.ts" ],
    [ "@tauri-apps/api/image", "tauri-v2/packages/api/src/image.ts" ],
    [ "@tauri-apps/api/menu", "tauri-v2/packages/api/src/menu.ts"  ],
    [ "@tauri-apps/api/mocks", "tauri-v2/packages/api/src/mocks.ts" ],
    [ "@tauri-apps/api/path", "tauri-v2/packages/api/src/path.ts" ],
    [ "@tauri-apps/api/tray", "tauri-v2/packages/api/src/tray.ts" ],
    [ "@tauri-apps/api/webview", "tauri-v2/packages/api/src/webview.ts"  ],
    [ "@tauri-apps/api/webviewWindow", "tauri-v2/packages/api/src/webviewWindow.ts" ],
